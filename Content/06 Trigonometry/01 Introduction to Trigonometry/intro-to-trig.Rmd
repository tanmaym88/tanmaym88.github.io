...
<div class="fragment">
![trig-icon](images/060101.svg){height=20%, width=20%}
</div>
...
![angle](images/060102.svg){height=15%, width=15%}
</div>
<div class="fragment">
...
<div class="fragment">
**Sign Convention:** The sign of the angle is considered to be positive or negative, according as the ray is rotated in the anticlockwise or the clockwise direction.<br>
![sense-of-angle](images/060103.svg){height=40%, width=40%}
</div>
